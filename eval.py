...
flags.DEFINE_integer("n_samples", None, "How many samples, dataset long.")
flags.DEFINE_string("sample_path", None, "The path to samples output.")
flags.DEFINE_string("dataset_path", None, "The path to input datapath.")
flags.DEFINE_integer("cls_number", None, "Whitch cls to sample.")
...
def main(argv):
    ...
    config.dataset.cls_number = FLAGS.cls_number
    evaluate(config)
